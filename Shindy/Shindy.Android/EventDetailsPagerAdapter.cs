...
{
    public class EventDetailsPagerAdapter:FragmentPagerAdapter
    {
        int PAGE_COUNT;
        private string[] tabTitles;
        readonly Context context;

        public EventDetailsPagerAdapter(IntPtr javaReference, JniHandleOwnership transfer) : base(javaReference, transfer)
        {
        }

        public EventDetailsPagerAdapter(Context context, FragmentManager fm,string[] tabTitles,int pageCount) : base(fm)
        {
        ...
        {
            return EventDetailsPageFragment.newInstance(position + 1);
        }
